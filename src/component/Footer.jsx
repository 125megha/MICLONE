...
const Footer = ({footer}) => {
    return (
        ...
        <div className="PreFooter">
            <div>
                {repeatIcon}
                <p><b>Hassle-free replacament</b> <br/>10-days easy replacament policy on mi.com</p>
            </div>
            <div>{shieldIcon}<p> <b>100% secure payments</b> <br/> We support Cards, Wallets, EMI and COD</p>
            </div>
        ...
        <div className="PreFooter2">
            ...
            <div>
                ...
                <span> Thanks. You're on our email list for special offres.</span>
            </div>
